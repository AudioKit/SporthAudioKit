...
import AudioKit
import Foundation
@testable import SporthAudioKit
import XCTest

class GenericOperationTests: XCTestCase {
    func defaultTest(_ md5: String, _ operation: SporthAudioKit.Operation, audition: Bool = false) {
    ...
    func testGenerators() {
        ...
        defaultTest("d9f1c155c150b5be489377ac7d510367", Operation.fmOscillator(baseFrequency: 10000 * ramp))
        defaultTest("df1279e80a00419a84ded35141c088e4", Operation.fmOscillator(carrierMultiplier: 1000 * ramp))
    ...
    func testEffects() {
        ...
        defaultTest("5d28729547dbfb905eb890fe6ef3b5c6", input.bitCrush(sampleRate: 4000))
        defaultTest("3fdcc5e1cae820dd78ac5899ca1f8c8a", input.bitCrush(bitDepth: 7, sampleRate: 4000))
        ...
        defaultTest("8e1d867e88945e87c5bcdcacad40f1d0", input.korgLowPassFilter(cutoffFrequency: 2000))
        ...
        defaultTest("172e0909b75f65a3177d39b35dd2fc1c", input.korgLowPassFilter(cutoffFrequency: 2000, resonance: 0.9, saturation: 0.5))
