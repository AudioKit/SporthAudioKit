...
public extension ComputedParameter {
    ...
    ///
    func delay(time: Double = 1.0, feedback: OperationParameter = 0.0) -> Operation {
    ...
    ///
    func smoothDelay(time: OperationParameter = 1.0,
    ...
    ///   - maximumDelayTime: The maximum delay time, in seconds. (Default: 5.0, Minimum: 0.0, Maximum: 10.0)
    ///
    func variableDelay(time: OperationParameter = 1.0,
                       feedback: OperationParameter = 0.0,
                       maximumDelayTime: Double = 5.0) -> Operation
    {
