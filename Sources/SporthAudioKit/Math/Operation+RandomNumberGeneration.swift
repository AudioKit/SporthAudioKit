...
public extension Operation {
    ...
    ///
    static func jitter(amplitude: OperationParameter = 0.5,
    ...
    ///
    static func randomNumberPulse(minimum: OperationParameter = 0,
    ...
    ///
    static func randomVertexPulse(minimum: OperationParameter = 0,
                                  maximum: OperationParameter = 1,
