...
public extension Operation {
    ...
    ///
    static func fmOscillator(baseFrequency: OperationParameter = 440,
    ...
    ///
    static func morphingOscillator(frequency: OperationParameter = 440,
    ...
    ///
    static func phasor(frequency: OperationParameter = 1, phase: Double = 0) -> Operation {
    ...
    ///
    static func sawtooth(frequency: OperationParameter = 440,
    ...
    ///   - amplitude: Output Amplitude. (Default: 0.5, Minimum: 0.0, Maximum: 1.0)
    ///
    static func reverseSawtooth(frequency: OperationParameter = 440,
                                amplitude: OperationParameter = 0.5,
                                phase: OperationParameter = 0) -> Operation
    {
    ...
    ///   - amplitude: Output Amplitude. (Default: 0.5, Minimum: 0.0, Maximum: 1.0)
    ///
    static func sawtoothWave(frequency: OperationParameter = 440,
                             amplitude: OperationParameter = 0.5) -> Operation
    {
    ...
    ///   - amplitude: Amplitude of the output (Default: 1)
    ///
    static func sineWave(frequency: OperationParameter = 440,
    ...
    ///   - amplitude: Output Amplitude. (Default: 0.5, Minimum: 0.0, Maximum: 1.0)
    ///
    static func square(frequency: OperationParameter = 440,
                       amplitude: OperationParameter = 0.5,
                       phase: OperationParameter = 0) -> Operation
    {
    ...
    ///
    static func squareWave(frequency: OperationParameter = 440,
    ...
    ///   - amplitude: Output Amplitude. (Default: 0.5, Minimum: 0.0, Maximum: 1.0)
    ///
    static func triangle(frequency: OperationParameter = 440,
                         amplitude: OperationParameter = 0.5,
                         phase: OperationParameter = 0) -> Operation
    {
    ...
    ///   - amplitude: Output Amplitude. (Default: 0.5, Minimum: 0.0, Maximum: 1.0)
    ///
    static func triangleWave(frequency: OperationParameter = 440,
                             amplitude: OperationParameter = 0.5) -> Operation
    {
